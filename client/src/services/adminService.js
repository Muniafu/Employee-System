...
export const createDept = (d) => api.post('/admin/departments', d);
export const updateDept = (id, d) => api.put(`/admin/departments/${id}`, d);
export const getPolicies = () => api.get('/admin/policies');
export const createPolicy = (d) => api.post('/admin/policies', d);
export const getAuditLog = (p) => api.get('/admin/audit', { params: p });
export const registerAdmin = (d) => api.post('/auth/register-admin', d);